...
FINAL_IMAGE=${DISTDIR}/Ejemplos_clase.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ejemplo1.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ejemplo1.o
POSSIBLE_DEPFILES=${OBJECTDIR}/ejemplo1.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ejemplo1.o

# Source Files
SOURCEFILES=ejemplo1.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Ejemplos_clase.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F887
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Ejemplos_clase.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/ejemplo1.o: ejemplo1.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ejemplo1.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/ejemplo1.o \
	ejemplo1.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Ejemplos_clase.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F887 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Ejemplos_clase.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
