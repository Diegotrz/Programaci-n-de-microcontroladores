...
SOURCEFILES_QUOTED_IF_SPACED=Postlab_5.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Postlab_5.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Postlab_5.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Postlab_5.o

# Source Files
SOURCEFILES=Postlab_5.s
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Lab5.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Postlab_5.o: Postlab_5.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Postlab_5.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/Postlab_5.o \
	Postlab_5.s \
...
${DISTDIR}/Lab5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/Lab5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
